...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with tab_recv:
        ...
        if not prods:
            ...
            c1,c2,c3    = st.columns(3)
            recv_qty    = c1.number_input("Quantity", min_value=1, value=1)
            recv_source = c2.text_input("Received From")
            recv_price  = c3.number_input("Price per unit (₹)", min_value=0.0, value=0.0)
    ...
    with tab_issue:
        ...
        if not prods:
            ...
            c1,c2       = st.columns(2)
            issue_qty   = c1.number_input("Quantity", min_value=1, value=1)
            issue_to    = c2.text_input("Issued To")
